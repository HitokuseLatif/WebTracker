...
class TrackedSitesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create tracked_site" do
    assert_difference('TrackedSite.count') do
      post tracked_sites_url, params: { tracked_site: { homepageURL: @tracked_site.homepageURL, totalPV: @tracked_site.totalPV } }
    end
  ...
  test "should update tracked_site" do
    patch tracked_site_url(@tracked_site), params: { tracked_site: { homepageURL: @tracked_site.homepageURL, totalPV: @tracked_site.totalPV } }
